...
**Validation:** Absence of PMTiles produces a validation **warning**, not an error. PMTiles improve web display but are not required for valid catalogs. See [ADR-0003](context/shared/adr/0003-plugin-architecture.md) for details.
