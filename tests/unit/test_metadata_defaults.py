...
class TestApplyRasterNodataDefaults:
    ...
    def test_existing_nodata_not_overridden(self) -> None:
        ...
        # Band 1 keeps 255, bands 2-3 get default 0
    ...
    def test_per_band_nodata_length_mismatch_pads(self) -> None:
        """Per-band nodata shorter than band count pads with last value."""
