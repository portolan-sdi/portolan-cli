...
## Active Technologies
- Python 3.10+ + Existing validation framework (`portolan_cli/validation/`) (001-pmtiles-recommended)
- N/A (documentation changes + validation rule) (001-pmtiles-recommended)

## Recent Changes
- 001-pmtiles-recommended: Added Python 3.10+ + Existing validation framework (`portolan_cli/validation/`)
