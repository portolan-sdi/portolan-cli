...
- MetadataExtracted: Harvested metadata from ArcGIS service
...
@dataclass
class LayerResult:
    """Result of extracting a single ArcGIS layer.

    Attributes:
        id: ArcGIS layer ID (integer from service).
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        None values are excluded from the output to keep reports clean,
        except for the id, name, status, warnings, and attempts fields
...
class MetadataExtracted:
    """Metadata harvested from ArcGIS service.
    ...
    Attributes:
        ...
        processing_notes: Service description (serviceDescription field).
        known_issues: Access information or caveats (accessInformation field).
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        All fields are included (including None) to document what was checked.
        """
        return {
...
class ExtractionReport:
    """Complete extraction report for an ArcGIS service.
